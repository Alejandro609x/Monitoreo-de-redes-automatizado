...
sender_email = 'tucorreo@gmail.com'  # Correo del remitente.
sender_password = 'no tu contraseña de correo se llama contraseña para aplicacion y de debe configurar en google'  # Contraseña del remitente.
receiver_email = 'correodestinatario@gmail.com'  # Correo del destinatario.
